...
#define DCAMCONST_FRAMESTAMP_MISMATCH 0xFFFFFFFF
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMERR){
        ...
        DCAMERR_DEVICEPROBLEM =
            0x82001002, /*		initialization failed(for maico)	*/
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMREC_METADATAOPTION){
        ...
        DCAMREC_METADATAOPTION__LOCATION__MASK =
            0xFF000000} DCAM_DECLARE_END(DCAMREC_METADATAOPTION);
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMWAIT_EVENT){
        ...
        DCAMWAIT_RECEVENT_WRITEFRAME =
            0x8000, /* DCAMCAP_START_BUFRECORD only */
    ...
    DCAM_DECLARE_BEGIN(enum, DCAM_IDSTR){
        ...
        DCAM_IDSTR_OPTICALBLOCK_CHANNEL_2 =
            0x04001105} DCAM_DECLARE_END(DCAM_IDSTR);
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMAPI_INITOPTION){
        ...
        DCAMAPI_INITOPTION_ENDMARK =
            0x00000000} DCAM_DECLARE_END(DCAMAPI_INITOPTION);
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMDATA_ATTRIBUTE){
        DCAMDATA_ATTRIBUTE__ACCESSREADY =
            0x01000000, /* This value can get or set at READY status */
        DCAMDATA_ATTRIBUTE__ACCESSBUSY =
            0x02000000, /* This value can get or set at BUSY status */

        DCAMDATA_ATTRIBUTE__HASVIEW =
            0x10000000, /* value can set the value for each views	*/
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMDATA_REGIONTYPE){
        ...
        DCAMDATA_REGIONTYPE__NONE =
            0x00000000} DCAM_DECLARE_END(DCAMDATA_REGIONTYPE);
    ...
    DCAM_DECLARE_BEGIN(enum, DCAMDEV_CAPDOMAIN){
        ...
        DCAMDEV_CAPDOMAIN__FUNCTION =
            0x00000000} DCAM_DECLARE_END(DCAMDEV_CAPDOMAIN);
    ...
    DCAM_DECLARE_BEGIN(struct, DCAMAPI_INIT)
    {
        ...
        const int32 *
            initoption; // [in ptr] initialize options. Choose from DCAMAPI_INITOPTION
    ...
    DCAM_DECLARE_BEGIN(struct, DCAMDEV_CAPABILITY_FRAMEOPTION)
    {
        ...
        int32
            supportproc; // [out] support DCAMBUF_PROCTYPE__* flags in the camera. hdr.capflag may be 0 if the function doesn't work in current condition.
    }
    ...
    DCAM_DECLARE_BEGIN(struct, DCAMPROP_ATTR)
    {
        ...
        int32
              iProp_NumberOfElement; //	property id to get number of elements of this property if it is array
    ...
    DCAM_DECLARE_BEGIN(struct, DCAM_METADATABLOCKHDR)
    {
        ...
        int32 iKind; // [in] DCAM_METADATAKIND
        int32
              option; // [in] value meaning depends on DCAMBUF_METADATAOPTION or DCAMREC_METADATAOPTION
    ...
    DCAM_DECLARE_BEGIN(struct, DCAM_TIMESTAMPBLOCK)
    {
        ...
        int32
            timestampvaildsize; // [o] return the written data size of DCAM_TIMESTRAMP.
        int32
            timestampkind; // [o] return timestamp kind(Hardware, Driver, DCAM etc..)
        int32 reserved;
    }
    ...
    DCAMERR DCAMAPI dcamprop_setgetvalue(HDCAM        h,
                                         int32        iProp,
                                         double      *pValue,
                                         int32 option DCAM_DEFAULT_ARG);
    DCAMERR DCAMAPI dcamprop_queryvalue(HDCAM        h,
                                        int32        iProp,
                                        double      *pValue,
                                        int32 option DCAM_DEFAULT_ARG);
    DCAMERR DCAMAPI dcamprop_getnextid(HDCAM        h,
                                       int32       *pProp,
                                       int32 option DCAM_DEFAULT_ARG);
    DCAMERR DCAMAPI dcamprop_getname(HDCAM h,
                                     int32 iProp,
                                     char *text,
                                     int32 textbytes);
    ...
    // Buffer control
    DCAMERR DCAMAPI
    dcambuf_alloc(HDCAM h, int32 framecount); // call dcambuf_release() to free.
    ...
    DCAMERR DCAMAPI dcamrec_writemetadata(HDCAMREC                hrec,
    ...
    DCAMERR DCAMAPI dcamrec_lockmetadatablock(HDCAMREC               hrec,
                                              DCAM_METADATABLOCKHDR *hdr);
    DCAMERR DCAMAPI dcamrec_copymetadatablock(HDCAMREC               hrec,
                                              DCAM_METADATABLOCKHDR *hdr);
