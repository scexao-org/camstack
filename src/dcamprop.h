 ...
 * **************************************************************** */
    ...
    typedef enum _DCAMPROPOPTION
    {
        ...
        DCAMPROP_OPTION_UPDATED =
            0x00000001, /* UPDATED and VOLATILE can be used at same time */
        DCAMPROP_OPTION_VOLATILE =
            0x00000002, /* UPDATED and VOLATILE can be used at same time */
    ...
    typedef enum _DCAMPROPATTRIBUTE
    {
        ...
        DCAMPROP_ATTR_HASCHANNEL =
            0x08000000, /* value can set the value for each channels */
        ...
        /* values.																			*/
        DCAMPROP_ATTR_DATASTREAM =
            0x00200000, /* value is releated to image attribute		*/

        DCAMPROP_ATTR_HASRATIO =
            0x00100000, /* value has ratio control capability		*/

        DCAMPROP_ATTR_VOLATILE =
            0x00080000, /* value may be changed by user or automatically */

        DCAMPROP_ATTR_WRITABLE =
            0x00020000, /* value can be set when state is manual	*/
        DCAMPROP_ATTR_READABLE =
            0x00010000, /* value is readable when state is manual	*/

        DCAMPROP_ATTR_HASVIEW =
            0x00008000, /* value can set the value for each views	*/
        DCAMPROP_ATTR__SYSTEM = 0x00004000,
        /* system id								*/ /* reserved */

        DCAMPROP_ATTR_ACCESSREADY =
            0x00002000, /* This value can get or set at READY status */
        DCAMPROP_ATTR_ACCESSBUSY =
            0x00001000, /* This value can get or set at BUSY status */
        ...
        DCAMPROP_ATTR_EFFECTIVE =
            0x00000200, /* value is effective						*/

        /* property value type */
        DCAMPROP_TYPE_NONE =
            0x00000000, /* undefined 								*/
        DCAMPROP_TYPE_MODE =
            0x00000001, /* 01:	mode, 32bit integer in case of 32bit OS	*/
        DCAMPROP_TYPE_LONG =
            0x00000002, /* 02:	32bit integer in case of 32bit OS	*/
        DCAMPROP_TYPE_REAL =
            0x00000003, /* 03:	64bit float							*/
                        /*      no 32bit float						*/

        /* application has to use double-float type variable even the property is not REAL.	*/

        DCAMPROP_TYPE_MASK =
            0x0000000F /* mask for property value type				*/
    } DCAMPROPATTRIBUTE;
    ...
    typedef enum _DCAMPROPATTRIBUTE2
    {
        ...
        DCAMPROP_ATTR2_CHANNELSEPARATEDDATA =
            0x00040000, /* Channel 0 value is total of each channels. */
    ...
    typedef enum _DCAMPROPMODEVALUE
    {
        ...
        DCAMPROP_OUTPUTTRIGGER_ACTIVE__LEVEL =
            2, /*	"LEVEL"					*/
               /*	DCAMPROP_OUTPUTTRIGGER_ACTIVE__PULSE		= 3,	*/
        /*	"PULSE"					*/ /* reserved */
        ...
        /*	DCAMPROP_MECHANICALSHUTTER_AUTOMODE__OPEN_WHEN_EXPOSURE	= 1,*/
        /* "OPEN WHEN EXPOSURE"	*/ /* reserved */
        /*	DCAMPROP_MECHANICALSHUTTER_AUTOMODE__CLOSE_WHEN_READOUT	= 2,*/
        /* "CLOSE WHEN READOUT"	*/ /* reserved */
        ...
        DCAMPROP_CAPTUREMODE__SHADINGCALIB =
            3, /*	"SHADING CALIBRATION"	*/
        DCAMPROP_CAPTUREMODE__TAPGAINCALIB =
            4, /*	"TAP GAIN CALIBRATION"	*/
        ...
        DCAMPROP_CONFOCAL_SCANMODE__SIMULTANEOUS =
            1, /*	"SIMULTANEOUS"			*/
        DCAMPROP_CONFOCAL_SCANMODE__SEQUENTIAL =
            2, /*	"SEQUENTIAL"			*/

        /* DCAM_IDPROP_SUBUNIT_CONTROL */
        DCAMPROP_SUBUNIT_CONTROL__NOTINSTALLED =
            0, /*	"NOT INSTALLED"			*/
        ...
        DCAMPROP_SWITCHMODE_OFF =
            DCAMPROP_MODE__OFF, /*	"OFF"					*/
        DCAMPROP_SWITCHMODE_ON =
            DCAMPROP_MODE__ON, /*	"ON"					*/

        DCAMPROP_TRIGGERACTIVE__PULSE =
            DCAMPROP_TRIGGERACTIVE__SYNCREADOUT, /*	was "PULSE"	*/

        DCAMPROP_READOUT_DIRECTION__NORMAL =
            DCAMPROP_READOUT_DIRECTION__FORWARD, /* VALUETEXT was "NORMAL"	*/
        DCAMPROP_READOUT_DIRECTION__REVERSE =
            DCAMPROP_READOUT_DIRECTION__BACKWARD, /* VALUETEXT was "REVERSE"	*/
  ...
  ****************************************************************  */
    ...
    typedef enum _DCAMIDPROP
    {
        ...
        /* Group: TIMING */
        DCAM_IDPROP_TRIGGERSOURCE =
            0x00100110, /* R/W, mode,	"TRIGGER SOURCE"		*/
        DCAM_IDPROP_TRIGGERACTIVE =
            0x00100120, /* R/W, mode,	"TRIGGER ACTIVE"		*/
        DCAM_IDPROP_TRIGGER_MODE =
            0x00100210, /* R/W, mode,	"TRIGGER MODE"			*/
        DCAM_IDPROP_TRIGGERPOLARITY =
            0x00100220, /* R/W, mode,	"TRIGGER POLARITY"		*/
        DCAM_IDPROP_TRIGGER_CONNECTOR =
            0x00100230, /* R/W, mode,	"TRIGGER CONNECTOR"		*/
        DCAM_IDPROP_TRIGGERTIMES =
            0x00100240, /* R/W, long,	"TRIGGER TIMES"			*/
                        /*	  0x00100250 is reserved */
        DCAM_IDPROP_TRIGGERDELAY =
            0x00100260, /* R/W, sec,	"TRIGGER DELAY"			*/
        DCAM_IDPROP_INTERNALTRIGGER_HANDLING =
            0x00100270, /* R/W, mode,	"INTERNAL TRIGGER HANDLING"*/
        DCAM_IDPROP_TRIGGERMULTIFRAME_COUNT =
            0x00100280, /* R/W, long,	"TRIGGER MULTI FRAME COUNT"*/
        DCAM_IDPROP_SYNCREADOUT_SYSTEMBLANK =
            0x00100290, /* R/W, mode,	"SYNC READOUT SYSTEM BLANK" */

        DCAM_IDPROP_TRIGGERENABLE_ACTIVE =
            0x00100410, /* R/W, mode,	"TRIGGER ENABLE ACTIVE"	*/
        DCAM_IDPROP_TRIGGERENABLE_POLARITY =
            0x00100420, /* R/W, mode,	"TRIGGER ENABLE POLARITY"*/
        ...
        DCAM_IDPROP_OUTPUTTRIGGER_SOURCE =
            0x001C0110, /* R/W, mode,	"OUTPUT TRIGGER SOURCE"		*/
        DCAM_IDPROP_OUTPUTTRIGGER_POLARITY =
            0x001C0120, /* R/W, mode,	"OUTPUT TRIGGER POLARITY"	*/
        DCAM_IDPROP_OUTPUTTRIGGER_ACTIVE =
            0x001C0130, /* R/W, mode,	"OUTPUT TRIGGER ACTIVE"		*/
        DCAM_IDPROP_OUTPUTTRIGGER_DELAY =
            0x001C0140, /* R/W, sec,	"OUTPUT TRIGGER DELAY"		*/
        DCAM_IDPROP_OUTPUTTRIGGER_PERIOD =
            0x001C0150, /* R/W, sec,	"OUTPUT TRIGGER PERIOD"		*/
        DCAM_IDPROP_OUTPUTTRIGGER_KIND =
            0x001C0160, /* R/W, mode,	"OUTPUT TRIGGER KIND"		*/
        DCAM_IDPROP_OUTPUTTRIGGER_BASESENSOR =
            0x001C0170, /* R/W, mode,	"OUTPUT TRIGGER BASE SENSOR" */
        ...
        DCAM_IDPROP__OUTPUTTRIGGER =
            0x00000100, /* the offset of ID for Nth OUTPUT TRIGGER parameter */

        DCAM_IDPROP_MASTERPULSE_MODE =
            0x001E0020, /* R/W, mode,	"MASTER PULSE MODE"			*/
        DCAM_IDPROP_MASTERPULSE_TRIGGERSOURCE =
            0x001E0030, /* R/W, mode,	"MASTER PULSE TRIGGER SOURCE"	*/
        DCAM_IDPROP_MASTERPULSE_INTERVAL =
            0x001E0040, /* R/W, sec,	"MASTER PULSE INTERVAL"		*/
        DCAM_IDPROP_MASTERPULSE_BURSTTIMES =
            0x001E0050, /* R/W, long,	"MASTER PULSE BURST TIMES"	*/

        /* Group: FEATURE */
        /* exposure period */
        DCAM_IDPROP_EXPOSURETIME =
            0x001F0110, /* R/W, sec,	"EXPOSURE TIME"			*/
        DCAM_IDPROP_EXPOSURETIME_CONTROL =
            0x001F0130, /* R/W, mode,	"EXPOSURE TIME CONTROL"	*/
        DCAM_IDPROP_TRIGGER_FIRSTEXPOSURE =
            0x001F0200, /* R/W, mode,	"TRIGGER FIRST EXPOSURE"	*/
        DCAM_IDPROP_TRIGGER_GLOBALEXPOSURE =
            0x001F0300, /* R/W, mode,	"TRIGGER GLOBAL EXPOSURE"	*/
        DCAM_IDPROP_FIRSTTRIGGER_BEHAVIOR =
            0x001F0310, /* R/W, mode,	"FIRST TRIGGER BEHAVIOR"	*/
        DCAM_IDPROP_MULTIFRAME_EXPOSURE =
            0x001F1000, /* R/W, sec,	"MULTI FRAME EXPOSURE TIME"	*/
                        /*					 - 0x001F1FFF for 256 MULTI FRAME */
        DCAM_IDPROP__MULTIFRAME =
            0x00000010, /* the offset of ID for Nth MULTIFRAME */

        /* anti-blooming */
        DCAM_IDPROP_LIGHTMODE =
            0x00200110, /* R/W, mode,	"LIGHT MODE"			*/
                        /*	  0x00200120 is reserved */

        /* sensitivity */
        DCAM_IDPROP_SENSITIVITYMODE =
            0x00200210, /* R/W, mode,	"SENSITIVITY MODE"		*/
        DCAM_IDPROP_SENSITIVITY =
            0x00200220, /* R/W, long,	"SENSITIVITY"			*/

        DCAM_IDPROP_DIRECTEMGAIN_MODE =
            0x00200250, /* R/W, mode,	"DIRECT EM GAIN MODE"	*/
        DCAM_IDPROP_EMGAINWARNING_STATUS =
            0x00200260, /* R/O, mode,	"EM GAIN WARNING STATUS"*/
        DCAM_IDPROP_EMGAINWARNING_LEVEL =
            0x00200270, /* R/W, long,	"EM GAIN WARNING LEVEL"	*/
        DCAM_IDPROP_EMGAINWARNING_ALARM =
            0x00200280, /* R/W, mode,	"EM GAIN WARNING ALARM"	*/
        DCAM_IDPROP_EMGAINPROTECT_MODE =
            0x00200290, /* R/W, mode,	"EM GAIN PROTECT MODE"	*/
        DCAM_IDPROP_EMGAINPROTECT_AFTERFRAMES =
            0x002002A0, /* R/W, long,	"EM GAIN PROTECT AFTER FRAMES"	*/

        DCAM_IDPROP_MEASURED_SENSITIVITY =
            0x002002B0, /* R/O, real,	"MEASURED SENSITIVITY"	*/

        DCAM_IDPROP_PHOTONIMAGINGMODE =
            0x002002F0, /* R/W, mode,	"PHOTON IMAGING MODE"	*/

        /* sensor cooler */
        DCAM_IDPROP_SENSORTEMPERATURE =
            0x00200310, /* R/O, celsius,"SENSOR TEMPERATURE"	*/
        DCAM_IDPROP_SENSORCOOLER =
            0x00200320, /* R/W, mode,	"SENSOR COOLER"			*/
        DCAM_IDPROP_SENSORTEMPERATURETARGET =
            0x00200330, /* R/W, celsius,"SENSOR TEMPERATURE TARGET"	*/
        DCAM_IDPROP_SENSORCOOLERSTATUS =
            0x00200340, /* R/O, mode,	"SENSOR COOLER STATUS"	*/
        DCAM_IDPROP_SENSORCOOLERFAN =
            0x00200350, /* R/W, mode,	"SENSOR COOLER FAN"		*/
        DCAM_IDPROP_SENSORTEMPERATURE_AVE =
            0x00200360, /* R/O, celsius,"SENSOR TEMPERATURE AVE"	*/
        DCAM_IDPROP_SENSORTEMPERATURE_MIN =
            0x00200370, /* R/O, celsius,"SENSOR TEMPERATURE MIN"	*/
        DCAM_IDPROP_SENSORTEMPERATURE_MAX =
            0x00200380, /* R/O, celsius,"SENSOR TEMPERATURE MAX"	*/
        DCAM_IDPROP_SENSORTEMPERATURE_STATUS =
            0x00200390, /* R/O, mode,	"SENSOR TEMPERATURE STATUS"	*/
        DCAM_IDPROP_SENSORTEMPERATURE_PROTECT =
            0x00200400, /* R/W, mode,	"SENSOR TEMPERATURE MODE"	*/

        /* mechanical shutter */
        DCAM_IDPROP_MECHANICALSHUTTER =
            0x00200410, /* R/W, mode,	"MECHANICAL SHUTTER"	*/
        /*	DCAM_IDPROP_MECHANICALSHUTTER_AUTOMODE		= 0x00200420,*/
        /* R/W, mode,	"MECHANICAL SHUTTER AUTOMODE"	*/ /* reserved */

        /* contrast enhance */
        DCAM_IDPROP_CONTRASTGAIN =
            0x00300120, /* R/W, long,	"CONTRAST GAIN"			*/
        DCAM_IDPROP_CONTRASTOFFSET =
            0x00300130, /* R/W, long,	"CONTRAST OFFSET"		*/
                        /*	  0x00300140 is reserved */
        DCAM_IDPROP_HIGHDYNAMICRANGE_MODE =
            0x00300150, /* R/W, mode,	"HIGH DYNAMIC RANGE MODE"	*/
        DCAM_IDPROP_DIRECTGAIN_MODE =
            0x00300160, /* R/W, mode,	"DIRECT GAIN MODE"		*/
        ...
        /* R/W, mode,	"VIVID COLOR"			*/ /*[C7780]*/
        DCAM_IDPROP_WHITEBALANCEMODE =
            0x00300210, /* R/W, mode,	"WHITEBALANCE MODE"		*/
        DCAM_IDPROP_WHITEBALANCETEMPERATURE =
            0x00300220, /* R/W, color-temp., "WHITEBALANCE TEMPERATURE"	*/
        DCAM_IDPROP_WHITEBALANCEUSERPRESET =
            0x00300230, /* R/W, long,	"WHITEBALANCE USER PRESET"		*/
        ...
        /* ALU */
        DCAM_IDPROP_INTERFRAMEALU_ENABLE =
            0x00380010, /* R/W, mode,	"INTERFRAME ALU ENABLE"	*/
        DCAM_IDPROP_RECURSIVEFILTER =
            0x00380110, /* R/W, mode,	"RECURSIVE FILTER"		*/
        DCAM_IDPROP_RECURSIVEFILTERFRAMES =
            0x00380120, /* R/W, long,	"RECURSIVE FILTER FRAMES"*/
        DCAM_IDPROP_SPOTNOISEREDUCER =
            0x00380130, /* R/W, mode,	"SPOT NOISE REDUCER"	*/
        DCAM_IDPROP_SUBTRACT =
            0x00380210, /* R/W, mode,	"SUBTRACT"				*/
        DCAM_IDPROP_SUBTRACTIMAGEMEMORY =
            0x00380220, /* R/W, mode,	"SUBTRACT IMAGE MEMORY"	*/
        DCAM_IDPROP_STORESUBTRACTIMAGETOMEMORY =
            0x00380230, /* W/O, mode,	"STORE SUBTRACT IMAGE TO MEMORY"	*/
        DCAM_IDPROP_SUBTRACTOFFSET =
            0x00380240, /* R/W, long	"SUBTRACT OFFSET"		*/
        ...
        DCAM_IDPROP_SUBTRACT_DATASTATUS =
            0x003802F0, /* R/W	mode,	"SUBTRACT DATA STATUS"	*/
        DCAM_IDPROP_SHADINGCALIB_DATASTATUS =
            0x00380300, /* R/W	mode,	"SHADING CALIB DATA STATUS"	*/
        DCAM_IDPROP_SHADINGCORRECTION =
            0x00380310, /* R/W, mode,	"SHADING CORRECTION"	*/
        DCAM_IDPROP_SHADINGCALIBDATAMEMORY =
            0x00380320, /* R/W, mode,	"SHADING CALIB DATA MEMORY"		*/
        DCAM_IDPROP_STORESHADINGCALIBDATATOMEMORY =
            0x00380330, /* W/O, mode,	"STORE SHADING DATA TO MEMORY"	*/
        DCAM_IDPROP_SHADINGCALIB_METHOD =
            0x00380340, /* R/W, mode,	"SHADING CALIB METHOD"	*/
        DCAM_IDPROP_SHADINGCALIB_TARGET =
            0x00380350, /* R/W, long,	"SHADING CALIB TARGET"	*/
        ...
        DCAM_IDPROP_SHADINGCALIB_SAMPLES =
            0x00380370, /* R/W, long,	"SHADING CALIB SAMPLES"	*/
        ...
        DCAM_IDPROP_FRAMEAVERAGINGMODE =
            0x003803A0, /* R/W, mode,	"FRAME AVERAGING MODE"		*/
        DCAM_IDPROP_FRAMEAVERAGINGFRAMES =
            0x003803B0, /* R/W, long,	"FRAME AVERAGING FRAMES"*/
        DCAM_IDPROP_DARKCALIB_STABLESAMPLES =
            0x003803C0, /* R/W, long,	"DARKCALIB STABLE SAMPLES"	*/
        DCAM_IDPROP_DARKCALIB_SAMPLES =
            0x003803D0, /* R/W, long,	"DARKCALIB SAMPLES"	*/
        DCAM_IDPROP_DARKCALIB_TARGET =
            0x003803E0, /* R/W, long,	"DARKCALIB TARGET" */
        DCAM_IDPROP_CAPTUREMODE =
            0x00380410, /* R/W, mode,	"CAPTURE MODE"			*/
        DCAM_IDPROP_LINEAVERAGING =
            0x00380450, /* R/W, long,	"LINE AVERAGING"	*/
        DCAM_IDPROP_INTENSITYLUT_MODE =
            0x00380510, /* R/W, mode,	"INTENSITY LUT MODE"	*/
        DCAM_IDPROP_INTENSITYLUT_PAGE =
            0x00380520, /* R/W, long,	"INTENSITY LUT PAGE"	*/
        DCAM_IDPROP_INTENSITYLUT_WHITECLIP =
            0x00380530, /* R/W, long,	"INTENSITY LUT WHITE CLIP"	*/
        DCAM_IDPROP_INTENSITYLUT_BLACKCLIP =
            0x00380540, /* R/W, long,	"INTENSITY LUT BLACK CLIP"	*/
        DCAM_IDPROP_INTENSITY_GAMMA =
            0x00380560, /* R/W, real,	"INTENSITY GAMMA"	*/
        DCAM_IDPROP_SENSORGAPCORRECT_MODE =
            0x00380620, /* R/W, long,	"SENSOR GAP CORRECT MODE"	*/
        ...
        /* TAP CALIBRATION */
        DCAM_IDPROP_TAPGAINCALIB_METHOD =
            0x00380F10, /* R/W, mode,	"TAP GAIN CALIB METHOD"	*/
        DCAM_IDPROP_TAPCALIB_BASEDATAMEMORY =
            0x00380F20, /* R/W, mode,	"TAP CALIB BASE DATA MEMORY"*/
        DCAM_IDPROP_STORETAPCALIBDATATOMEMORY =
            0x00380F30, /* W/O, mode,	"STORE TAP CALIB DATA TO MEMORY"*/
        DCAM_IDPROP_TAPCALIBDATAMEMORY =
            0x00380F40, /* W/O, mode,	"TAP CALIB DATA MEMORY"	*/
        DCAM_IDPROP_NUMBEROF_TAPCALIB =
            0x00380FF0, /* R/W, long,	"NUMBER OF TAP CALIB"	*/
        DCAM_IDPROP_TAPCALIB_GAIN =
            0x00381000, /* R/W, mode,	"TAP CALIB GAIN"		*/
        DCAM_IDPROP_TAPCALIB_OFFSET =
            0x00382000, /* R/W, mode,	"TAP CALIB OFFSET"		*/
        DCAM_IDPROP__TAPCALIB =
            0x00000010, /* the offset of ID for Nth TAPCALIB	*/

        /* Group: READOUT */
        /* readout speed */
        DCAM_IDPROP_READOUTSPEED =
            0x00400110, /* R/W, long,	"READOUT SPEED" 		*/
                        /*	  0x00400120 is reserved */
        DCAM_IDPROP_READOUT_DIRECTION =
            0x00400130, /* R/W, mode,	"READOUT DIRECTION"		*/
        DCAM_IDPROP_READOUT_UNIT =
            0x00400140, /* R/O, mode,	"READOUT UNIT"			*/

        DCAM_IDPROP_SHUTTER_MODE =
            0x00400150, /* R/W, mode,	"SHUTTER MODE"			*/

        /* sensor mode */
        DCAM_IDPROP_SENSORMODE =
            0x00400210, /* R/W, mode,	"SENSOR MODE"			*/
        ...
        /* other readout mode */
        DCAM_IDPROP_CCDMODE =
            0x00400310, /* R/W, mode,	"CCD MODE"				*/
        DCAM_IDPROP_EMCCD_CALIBRATIONMODE =
            0x00400320, /* R/W, mode,	"EM CCD CALIBRATION MODE"	*/
        DCAM_IDPROP_CMOSMODE =
            0x00400350, /* R/W, mode,	"CMOS MODE"				*/

        /* output mode */
        DCAM_IDPROP_OUTPUT_INTENSITY =
            0x00400410, /* R/W, mode,	"OUTPUT INTENSITY"		*/
        ...
        DCAM_IDPROP_OUTPUTDATA_OPERATION =
            0x00400440, /* R/W, mode,	"OUTPUT DATA OPERATION"	*/

        DCAM_IDPROP_TESTPATTERN_KIND =
            0x00400510, /* R/W, mode,	"TEST PATTERN KIND"		*/
        DCAM_IDPROP_TESTPATTERN_OPTION =
            0x00400520, /* R/W, long,	"TEST PATTERN OPTION"	*/

        DCAM_IDPROP_EXTRACTION_MODE =
            0x00400620, /* R/W	mode,	"EXTRACTION MODE	"*/

        /* Group: ROI */
        /* binning and subarray */
        DCAM_IDPROP_BINNING =
            0x00401110, /* R/W, mode,	"BINNING"				*/
        DCAM_IDPROP_BINNING_INDEPENDENT =
            0x00401120, /* R/W, mode,	"BINNING INDEPENDENT"	*/
        DCAM_IDPROP_BINNING_HORZ =
            0x00401130, /* R/W, long,	"BINNING HORZ"			*/
        DCAM_IDPROP_BINNING_VERT =
            0x00401140, /* R/W, long,	"BINNING VERT"			*/
        DCAM_IDPROP_SUBARRAYHPOS =
            0x00402110, /* R/W, long,	"SUBARRAY HPOS"			*/
        DCAM_IDPROP_SUBARRAYHSIZE =
            0x00402120, /* R/W, long,	"SUBARRAY HSIZE"		*/
        DCAM_IDPROP_SUBARRAYVPOS =
            0x00402130, /* R/W, long,	"SUBARRAY VPOS"			*/
        DCAM_IDPROP_SUBARRAYVSIZE =
            0x00402140, /* R/W, long,	"SUBARRAY VSIZE"		*/
        DCAM_IDPROP_SUBARRAYMODE =
            0x00402150, /* R/W, mode,	"SUBARRAY MODE"			*/
        DCAM_IDPROP_DIGITALBINNING_METHOD =
            0x00402160, /* R/W, mode,	"DIGITALBINNING METHOD"	*/
        DCAM_IDPROP_DIGITALBINNING_HORZ =
            0x00402170, /* R/W, long,	"DIGITALBINNING HORZ"	*/
        DCAM_IDPROP_DIGITALBINNING_VERT =
            0x00402180, /* R/W, long,	"DIGITALBINNING VERT"	*/

        /* Group: TIMING */
        /* synchronous timing */
        DCAM_IDPROP_TIMING_READOUTTIME =
            0x00403010, /* R/O, sec,	"TIMING READOUT TIME"			*/
        ...
        DCAM_IDPROP_TIMING_EXPOSURE =
            0x00403060, /* R/O, mode,	"TIMING EXPOSURE"			*/
        DCAM_IDPROP_TIMING_INVALIDEXPOSUREPERIOD =
            0x00403070, /* R/O, sec,	"INVALID EXPOSURE PERIOD"	*/
        DCAM_IDPROP_TIMING_FRAMESKIPNUMBER =
            0x00403080, /* R/W, long,	"TIMING FRAME SKIP NUMBER"	*/
        DCAM_IDPROP_TIMING_GLOBALEXPOSUREDELAY =
            0x00403090, /* R/O, sec,	"TIMING GLOBAL EXPOSURE DELAY"	*/

        DCAM_IDPROP_INTERNALFRAMERATE =
            0x00403810, /* R/W, 1/sec,	"INTERNAL FRAME RATE"		*/
        DCAM_IDPROP_INTERNAL_FRAMEINTERVAL =
            0x00403820, /* R/W, sec,	"INTERNAL FRAME INTERVAL"	*/
        DCAM_IDPROP_INTERNALLINERATE =
            0x00403830, /* R/W, 1/sec,	"INTERNAL LINE RATE"		*/
        DCAM_IDPROP_INTERNALLINESPEED =
            0x00403840, /* R/W, m/sec,	"INTERNAL LINE SPEEED"		*/
        DCAM_IDPROP_INTERNAL_LINEINTERVAL =
            0x00403850, /* R/W, sec,	"INTERNAL LINE INTERVAL"	*/

        /* system information */

        DCAM_IDPROP_TIMESTAMP_PRODUCER =
            0x00410A10, /* R/O, mode,	"TIME STAMP PRODUCER"	*/
        DCAM_IDPROP_FRAMESTAMP_PRODUCER =
            0x00410A20, /* R/O, mode,	"FRAME STAMP PRODUCER"	*/

        DCAM_IDPROP_TRANSFERINFO_FRAMECOUNT =
            0x00410B10, /* R/O, long,	"TRANSFER INFO FRAME COUNT" */
        DCAM_IDPROP_TRANSFERINFO_LOSTCOUNT =
            0x00410B11, /* R/O, long,	"TRANSFER INFO LOST COUNT" */
        ...
        DCAM_IDPROP_COLORTYPE =
            0x00420120, /* R/W, mode,	"COLORTYPE"				*/
        DCAM_IDPROP_BITSPERCHANNEL =
            0x00420130, /* R/W, long,	"BIT PER CHANNEL"		*/
                        /*	  0x00420140 is reserved */
                        /*	  0x00420150 is reserved */

        DCAM_IDPROP_NUMBEROF_CHANNEL =
            0x00420180, /* R/O, long,	"NUMBER OF CHANNEL"		*/
        DCAM_IDPROP_ACTIVE_CHANNELINDEX =
            0x00420190, /* R/W, mode,	"ACTIVE CHANNEL INDEX"	*/
        DCAM_IDPROP_NUMBEROF_VIEW =
            0x004201C0, /* R/O, long,	"NUMBER OF VIEW"		*/
        DCAM_IDPROP_ACTIVE_VIEWINDEX =
            0x004201D0, /* R/W, mode,	"ACTIVE VIEW INDEX"		*/

        DCAM_IDPROP_IMAGE_WIDTH =
            0x00420210, /* R/O, long,	"IMAGE WIDTH"			*/
        DCAM_IDPROP_IMAGE_HEIGHT =
            0x00420220, /* R/O, long,	"IMAGE HEIGHT"			*/
        DCAM_IDPROP_IMAGE_ROWBYTES =
            0x00420230, /* R/O, long,	"IMAGE ROWBYTES"		*/
        DCAM_IDPROP_IMAGE_FRAMEBYTES =
            0x00420240, /* R/O, long,	"IMAGE FRAMEBYTES"		*/
        DCAM_IDPROP_IMAGE_TOPOFFSETBYTES =
            0x00420250, /* R/O, long,	"IMAGE TOP OFFSET BYTES"*/
        DCAM_IDPROP_IMAGE_PIXELTYPE =
            0x00420270, /* R/W, DCAM_PIXELTYPE,	"IMAGE PIXEL TYPE"	*/
        DCAM_IDPROP_IMAGE_CAMERASTAMP =
            0x00420300, /* R/W, long,	"IMAGE CAMERA STAMP"	*/

        DCAM_IDPROP_BUFFER_ROWBYTES = 0x00420330,
        /* R/O, long,	"BUFFER ROWBYTES"		*/ /* dcambuf_attach() */
        DCAM_IDPROP_BUFFER_FRAMEBYTES = 0x00420340,
        /* R/O, long,	"BUFFER FRAME BYTES"		*/ /* dcambuf_attach() */
        DCAM_IDPROP_BUFFER_TOPOFFSETBYTES = 0x00420350,
        /* R/O, long,	"BUFFER TOP OFFSET BYTES"	*/ /* dcambuf_attach() */
        DCAM_IDPROP_BUFFER_PIXELTYPE = 0x00420360,
        /* R/O, DCAM_PIXELTYPE,	"BUFFER PIXEL TYPE"	*/ /* dcambuf_attach() */
        ...
        DCAM_IDPROP_FRAMEBUNDLE_MODE =
            0x00421010, /* R/W, mode,	"FRAMEBUNDLE MODE"		*/
        DCAM_IDPROP_FRAMEBUNDLE_NUMBER =
            0x00421020, /* R/W, long,	"FRAMEBUNDLE NUMBER"	*/
        DCAM_IDPROP_FRAMEBUNDLE_ROWBYTES =
            0x00421030, /* R/O,	long,	"FRAMEBUNDLE ROWBYTES"	*/
        DCAM_IDPROP_FRAMEBUNDLE_FRAMESTEPBYTES =
            0x00421040, /* R/O, long,	"FRAMEBUNDLE FRAME STEP BYTES"	*/

        /* partial area */
        DCAM_IDPROP_NUMBEROF_PARTIALAREA =
            0x00430010, /* R/W, long,	"NUMBER OF PARTIAL AREA"*/
        DCAM_IDPROP_PARTIALAREA_HPOS =
            0x00431000, /* R/W, long,	"PARTIAL AREA HPOS"		*/
        DCAM_IDPROP_PARTIALAREA_HSIZE =
            0x00432000, /* R/W, long,	"PARTIAL AREA HSIZE"	*/
        DCAM_IDPROP_PARTIALAREA_VPOS =
            0x00433000, /* R/W, long,	"PARTIAL AREA VPOS"		*/
        DCAM_IDPROP_PARTIALAREA_VSIZE =
            0x00434000, /* R/W, long,	"PARTIAL AREA VSIZE"	*/
        DCAM_IDPROP__PARTIALAREA =
            0x00000010, /* the offset of ID for Nth PARTIAL AREA */

        /* multi line */
        DCAM_IDPROP_NUMBEROF_MULTILINE =
            0x0044F010, /* R/W, long,	"NUMBER OF MULTI LINE"	*/
        DCAM_IDPROP_MULTILINE_VPOS =
            0x00450000, /* R/W, long,	"MULTI LINE VPOS"		*/
        DCAM_IDPROP_MULTILINE_VSIZE =
            0x00460000, /* R/W, long,	"MULTI LINE VSIZE"		*/
        /*				 - 0x0046FFFF for 4096 MULTI LINEs			*/ /* reserved */
        DCAM_IDPROP__MULTILINE =
            0x00000010, /* the offset of ID for Nth MULTI LINE */

        /* defect */
        DCAM_IDPROP_DEFECTCORRECT_MODE =
            0x00470010, /* R/W, mode,	"DEFECT CORRECT MODE"	*/
        DCAM_IDPROP_NUMBEROF_DEFECTCORRECT =
            0x00470020, /* R/W, long,	"NUMBER OF DEFECT CORRECT"	*/
        DCAM_IDPROP_HOTPIXELCORRECT_LEVEL =
            0x00470030, /* R/W, mode,	"HOT PIXEL CORRECT LEVEL"	*/
        DCAM_IDPROP_DEFECTCORRECT_HPOS =
            0x00471000, /* R/W, long,	"DEFECT CORRECT HPOS"		*/
        DCAM_IDPROP_DEFECTCORRECT_METHOD =
            0x00473000, /* R/W, mode,	"DEFECT CORRECT METHOD"		*/
                        /*				 - 0x0047FFFF for 256 DEFECT */
        DCAM_IDPROP__DEFECTCORRECT =
            0x00000010, /* the offset of ID for Nth DEFECT */

        /* Group: device buffer countrol */
        DCAM_IDPROP_DEVICEBUFFER_MODE =
            0x00490000, /* R/W, mode,	"DEVICE BUFFER MODE"	*/
        DCAM_IDPROP_DEVICEBUFFER_FRAMECOUNTMAX =
            0x00490020, /* R/O, long,	"DEVICE BUFFER FRAME COUNT MAX" */

        /* Group: CALIBREGION */
        DCAM_IDPROP_CALIBREGION_MODE =
            0x00402410, /* R/W, mode,	"CALIBRATE REGION MODE"		*/
        DCAM_IDPROP_NUMBEROF_CALIBREGION =
            0x00402420, /* R/W, long,	"NUMBER OF CALIBRATE REGION"*/
        DCAM_IDPROP_CALIBREGION_HPOS =
            0x004B0000, /* R/W, long,	"CALIBRATE REGION HPOS"		*/
        DCAM_IDPROP_CALIBREGION_HSIZE =
            0x004B1000, /* R/W, long,	"CALIBRATE REGION HSIZE"	*/
                        /*				 - 0x0048FFFF for 256 REGIONs at least		*/
        DCAM_IDPROP__CALIBREGION =
            0x00000010, /* the offset of ID for Nth REGION		*/

        /* Group: MASKREGION */
        DCAM_IDPROP_MASKREGION_MODE =
            0x00402510, /* R/W, mode,	"MASK REGION MODE"		*/
        DCAM_IDPROP_NUMBEROF_MASKREGION =
            0x00402520, /* R/W, long,	"NUMBER OF MASK REGION"	*/
        DCAM_IDPROP_MASKREGION_HPOS =
            0x004C0000, /* R/W, long,	"MASK REGION HPOS"		*/
        DCAM_IDPROP_MASKREGION_HSIZE =
            0x004C1000, /* R/W, long,	"MASK REGION HSIZE"		*/
                        /*				 - 0x0048FFFF for 256 REGIONs at least		*/
        ...
        DCAM_IDPROP_CAMERASTATUS_INPUTTRIGGER =
            0x004D1120, /* R/O, mode,	"CAMERASTATUS INPUT TRIGGER"*/
        DCAM_IDPROP_CAMERASTATUS_CALIBRATION =
            0x004D1130, /* R/O, mode,	"CAMERASTATUS CALIBRATION"	*/

        /* Group: Back Focus Position */
        DCAM_IDPROP_BACKFOCUSPOS_TARGET =
            0x00804010, /* R/W, micro-meter,"BACK FOCUS POSITION TARGET"	*/
        DCAM_IDPROP_BACKFOCUSPOS_CURRENT =
            0x00804020, /* R/O, micro-meter,"BACK FOCUS POSITION CURRENT"	*/
        ...
        /* Group: MAICO */
        DCAM_IDPROP_CONFOCAL_SCANMODE =
            0x00910010, /* R/W, mode,	"CONFOCAL SCAN MODE"	*/
        DCAM_IDPROP_CONFOCAL_SCANLINES =
            0x00910020, /* R/W, long,	"CONFOCAL SCANLINES"	*/
        DCAM_IDPROP_CONFOCAL_ZOOM =
            0x00910030, /* R/W, long,	"CONFOCAL ZOOM"			*/
        DCAM_IDPROP_SUBUNIT_IMAGEWIDTH =
            0x009100e0, /* R/O, long,	"SUBUNIT IMAGE WIDTH */

        DCAM_IDPROP_NUMBEROF_SUBUNIT =
            0x009100f0, /* R/O, long,	"NUMBER OF SUBUNIT"			*/
        DCAM_IDPROP_SUBUNIT_CONTROL =
            0x00910100, /* R/W, mode,	"SUBUNIT CONTROL"			*/
        DCAM_IDPROP_SUBUNIT_LASERPOWER =
            0x00910200, /* R/W, long,	"SUBUNIT LASERPOWER"		*/
        DCAM_IDPROP_SUBUNIT_PMTGAIN =
            0x00910300, /* R/W, real,	"SUBUNIT PMTGAIN"			*/
        DCAM_IDPROP_SUBUNIT_PINHOLESIZE =
            0x00910400, /* R/O, long,	"SUBUNIT PINHOLE SIZE"		*/
        DCAM_IDPROP_SUBUNIT_WAVELENGTH =
            0x00910500, /* R/O, long,	"SUBUNIT WAVELENGTH"		*/
        DCAM_IDPROP_SUBUNIT_TOPOFFSETBYTES =
            0x00910600, /* R/O, long,	"SUBUNIT TOP OFFSET BYTES"	*/

        DCAM_IDPROP__SUBUNIT =
            0x00000010, /* the offset of ID for Nth Subunit parameter */

        /* Group: SYSTEM */
        /* system property */

        DCAM_IDPROP_SYSTEM_ALIVE =
            0x00FF0010, /* R/O, mode,	"SYSTEM ALIVE"			*/

        DCAM_IDPROP_CONVERSIONFACTOR_COEFF =
            0x00FFE010, /* R/O, double,	"CONVERSION FACTOR COEFF"	*/
        DCAM_IDPROP_CONVERSIONFACTOR_OFFSET =
            0x00FFE020, /* R/O, double,	"CONVERSION FACTOR OFFSET"	*/
        ...
        DCAM_IDPROP_EXPOSURETIME_RATIO =
            DCAM_IDPROP__RATIO | DCAM_IDPROP_EXPOSURETIME, /* reserved */
        /* R/W, real,	"EXPOSURE TIME RATIO"	*/         /* reserved */
        DCAM_IDPROP_CONTRASTGAIN_RATIO =
            DCAM_IDPROP__RATIO | DCAM_IDPROP_CONTRASTGAIN, /* reserved */
        ...
        DCAM_IDPROP_ACTIVE_VIEWINDEXES =
            DCAM_IDPROP_ACTIVE_VIEWINDEX, /* reserved */
        ...
        DCAM_IDPROP_SYNC_MINTRIGGERBLANKING =
            DCAM_IDPROP_TIMING_MINTRIGGERBLANKING,
        ...
        DCAM_IDPROP_DARKCALIB_MAXIMUMINTENSITY =
            DCAM_IDPROP_DARKCALIB_STABLEMAXINTENSITY,
        DCAM_IDPROP_SUBTRACT_SAMPLINGCOUNT = DCAM_IDPROP_DARKCALIB_SAMPLES,

        DCAM_IDPROP_SHADINGCALIB_MINIMUMINTENSITY =
            DCAM_IDPROP_SHADINGCALIB_STABLEMININTENSITY,
        DCAM_IDPROP_SHADINGCALIB_STABLEFRAMECOUNT =
            DCAM_IDPROP_SHADINGCALIB_STABLESAMPLES,
        DCAM_IDPROP_SHADINGCALIB_INTENSITYMAXIMUMERRORPERCENTAGE =
            DCAM_IDPROP_SHADINGCALIB_STABLEMAXERRORPERCENT,
        DCAM_IDPROP_SHADINGCALIB_AVERAGEFRAMECOUNT =
            DCAM_IDPROP_SHADINGCALIB_SAMPLES,

        _end_of_dcam_idprop = 0
    } DCAMIDPROP;

#define DCAM_IDPROP_CHANNEL_(ch, id)                                           \
    ((DCAMIDPROP) (ch * DCAM_IDPROP__CHANNEL + (int32) id))
...
#define DCAM_IDPROP_VIEW_(view, id)                                            \
    ((DCAMIDPROP) (view * DCAM_IDPROP__VIEW + (int32) id))
