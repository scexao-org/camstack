...
from camstack.viewertools.vampires_plugins import MaskWheelPlugin, VisBlockPlugin
from camstack.viewertools.plugins import SaturationPlugin, PupilOverlayPlugin
import docopt
