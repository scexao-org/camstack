...
class OrcaQuest(DCAMCamera):
    ...
    # yapf: disable
    MODES = {
            FIRST: CameraMode(x0=0, x1=4095, y0=1004, y1=2303, tint=0.001),
            FULL: CameraMode(x0=0, x1=4095, y0=0, y1=2103, tint=0.001),
            FIRSTPL: CameraMode(x0=1500, x1=3395, y0=1580, y1=1983, tint=0.001),
