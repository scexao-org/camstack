...
if __name__ == "__main__":
    ...
    cam = Rajni('rajni', 'rajni', unit=3, channel=0, mode_id=mode,
                taker_cset_prio=('rajni_edt',
                                 41), dependent_processes=[tcp_recv, tcp_send])
    ...
    server.add_device(cam, pk.RAJNI, add_oneway_callables=True)
    server.start()
