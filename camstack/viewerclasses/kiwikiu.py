...
class KiwikiuViewerFrontend(PygameViewerFrontend):

    BOTTOM_PX_PAD = 100

    WINDOW_NAME = 'Kiwikiu LOWFS'

    HELP_MSG: str = """
Kiwikiy Camera Viewer
=======================================
...
class KiwikiuViewerBackend(GenericViewerBackend):
    pass
